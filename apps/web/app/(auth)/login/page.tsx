          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-gray-500">Nouveau sur ANAPI?</span>
              </div>
            </div>
            ...
            <div className="mt-6">
              <Link
                href="/register"
                className="w-full flex items-center justify-center gap-2 py-3 px-4 border-2 border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-gray-50 hover:border-gray-400 transition-all duration-200"
              >
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center px-12 text-white">
          <div className="max-w-lg text-center">
            ...
            <p className="text-lg text-blue-100 mb-8">
              Gerez efficacement les investissements, les autorisations, les ressources humaines et les operations administratives en un seul endroit.
            </p>
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-center gap-3">
                ...
                <span>Suivi des investissements en temps reel</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span>Guichet Unique des Autorisations, Licences et Permis</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span>Gestion complete des ressources humaines</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span>Rapports et analyses detailles</span>
              </div>
            </div>
          </div>
        </div>
