      ...
      <div className="print:hidden sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-semibold text-gray-900">Apercu du dossier</h1>
        ...
        >
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-200 text-xs">Republique Democratique du Congo</p>
                </div>
              </div>
          ...
          <div className="border-b-4 border-blue-600 p-6 bg-gray-50">
            ...
            <p className="text-center text-gray-500 mt-1">
              Document genere le {formatDate(new Date().toISOString())}
            </p>
          </div>
          ...
          <div className="p-8 print:p-6 space-y-8">
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  <p className="text-sm text-gray-500 uppercase tracking-wider">Secteur d'Activite</p>
                ...
                <div>
                  <p className="text-sm text-gray-500 uppercase tracking-wider">Date de Debut Prevue</p>
                  <p className="text-gray-900 font-medium mt-1 flex items-center gap-2">
                ...
                <div>
                  <p className="text-sm text-gray-500 uppercase tracking-wider">Date de Fin Prevue</p>
                  <p className="text-gray-900 font-medium mt-1 flex items-center gap-2">
                    <Calendar className="w-4 h-4 text-gray-400" />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">
                      {dossier.investorType === "company" ? "Societe" : "Investisseur Individuel"}
                    </p>
