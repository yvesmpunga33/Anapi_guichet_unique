        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            {searchTerm
              ...
              : "Commencez par creer un departement"}
          </p>
        </div>
      ) : (
            ...
            >
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                  ...
                  <span>{dept.employeeCount || 0} employes</span>
                </div>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                >
                  <option value="">Aucun (departement racine)</option>
                  {departments
              ...
              <div className="flex gap-3 pt-4">
                ...
                >
                  {editingDepartment ? "Modifier" : "Creer"}
                </button>
              </div>
            </form>
          </div>
