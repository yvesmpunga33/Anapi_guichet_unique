          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-blue-100 mt-1">
                Dossiers de demandes d'autorisations via le Guichet Unique
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/90 font-medium">Approuvees</p>
              </div>
            </div>
          </div>
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/90 font-medium">Rejetees</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-lg">Aucune autorisation trouvee</p>
          </div>
        ) : (
