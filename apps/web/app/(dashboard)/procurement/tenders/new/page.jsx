  ...
  useEffect(() => {
    const fetchMinistries = async () => {
      try {
        ...
        // L'API retourne { ministries: [...] } ou { success: true, data: [...] }
        if (data.ministries) {
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              Créez un nouvel appel d'offres ou marché public
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-2.5 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
                placeholder="Décrivez l'objectif de cet appel d'offres, les produits ou services attendus..."
              />
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                {tenderTypes.find((t) => t.value === formData.type)?.description}
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-4 py-2.5 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
                placeholder="Ex: Banque Mondiale, UE..."
              />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg mb-6 flex items-start gap-3">
            ...
            <p className="text-sm text-blue-700 dark:text-blue-300">
              La somme des pondérations technique et financière doit égaler 100%.
              Le score technique minimum est le seuil requis pour qu'une offre soit considérée.
            </p>
          </div>
          ...
          <div className="mt-4">
            <div className="flex h-4 rounded-full overflow-hidden bg-gray-200 dark:bg-slate-700">
              ...
              <div
                ...
                style={{ width: `${formData.financialWeight}%` }}
              />
            </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-6">
          ...
          {lots.length === 0 ? (
            <p className="text-gray-500 dark:text-gray-400 text-center py-8">
              Aucun lot ajouté. Cliquez sur "Ajouter un lot" pour diviser cet appel d'offres en lots.
            </p>
          ) : (
          ...
          <div className="space-y-4">
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-2.5 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
                placeholder="Conditions de participation, garanties exigées, documents requis..."
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-4 py-2.5 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
                placeholder="Notes internes (non visibles pour les soumissionnaires)..."
              />
            </div>
          </div>
        </div>
