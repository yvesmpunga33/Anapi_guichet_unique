...
import { Investor, Investment, ApprovalRequest, LegalDocument, sequelize } from '../../../../models';
...
export async function GET() {
  try {
    ...
    // Cast stats results
    const currentStats = investmentStats as any;
    const lastMonthStats = lastMonthInvestmentStats as any;
